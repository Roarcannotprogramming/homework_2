#ifdef CORE15_EXPORTS
#define CORE15_API __declspec(dllexport)
#else
#define CORE15_API __declspec(dllimport)
#endif
 ...
 */
CORE15_API void set_setting(int max_opearators, long max_range, int precision, 
 ...
 */
CORE15_API void generate(std::string* question, std::string* answer);